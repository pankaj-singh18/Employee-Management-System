...
def ADD_EMP():
    ...
    while b==1:
        ...
        mycursor.execute('''insert into emp_info values ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}',{},'{}',{},'{}','{}')'''. 
                         format(Emp_id,first_name,last_name,Father_Spouse_Name,Date_of_Birth,GradauteUG_PG,dept_id,regular,designation,email,
...
def maindata():
    try:
        mycursor.execute("SHOW DATABASES LIKE 'emp_manage'")
        if not mycursor.fetchone():
            print("Database not found. Creating database...")
            data_base()  # Call the function to create the database
        else:
    ...
    #dept_table()  # Create department table
    #sal_table()  # Create salary table
    #empinfo_table()  # Create employee table
    ...
    print("Setup complete. Proceeding to add or display employee records.\n\n")
